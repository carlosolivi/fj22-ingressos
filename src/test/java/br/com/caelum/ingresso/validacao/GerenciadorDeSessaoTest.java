...
public class GerenciadorDeSessaoTest {
	...
	private Sessao sessaoDasDezeioto;
	...
	public void preparaSessoes( ) {
		...
		this.sessaoDasDezeioto = new Sessao(LocalTime.parse("18:00:00"), rogueOne, sala3D);
	}
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes() {
		...
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez, sessaoDasDezeioto);
